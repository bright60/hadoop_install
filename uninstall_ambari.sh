...
remove_ambari_data()
{
	...
	$ssh_command $host "rm -rfv /var/lib/knox"
	...
	$ssh_command $host "rm -rfv /var/lib/spark"	
	$ssh_command $host "rm -rfv /var/lib/spark2"	
	...
	$ssh_command $host "rm -rfv /var/lib/ambari-server"
	$ssh_command $host "rm -rfv /var/lib/ambari-agent"
	$ssh_command $host "rm -rfv /var/lib/ambari-metrics-grafana"
	$ssh_command $host "rm -rfv /var/lib/ambari-metrics-monitor"
	$ssh_command $host "rm -rfv /var/lib/ambari-metrics-collector"
	$ssh_command $host "rm -rfv /var/lib/smartsense"	
